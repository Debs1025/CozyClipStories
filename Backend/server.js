...
const paymongoWebhookRoute = require('./routes/paymongoWebhookRoute');
...
connectFirebase()
  .then((db) => {
    ...
    require('./services/subscriptionWebhookService').startExpiryChecker(db);
