        ...
        <div className="flex-1 flex flex-col items-center bg-[#f9f2ed] p-6 sm:p-10 md:p-14 lg:p-16 overflow-y-auto">
          <div className="w-full max-w-lg transition-all duration-300">
            ...
            <div className="text-center mt-8 sm:mt-10">
              <p className="text-gray-600 text-base sm:text-lg mb-5 sm:mb-8">
                Sign up or continue using:
              </p>
              <div className="flex justify-center space-x-5 sm:space-x-6">
                {[
                  ...
                  <a
                    ...
                    className="transition transform hover:scale-110 bg-[#F3EBE2] border-2 border-[#9F8A8A] rounded-full p-1 shadow-md hover:shadow-lg"
                  >
                    <img
                      src={item.src}
                      alt="social-icon"
